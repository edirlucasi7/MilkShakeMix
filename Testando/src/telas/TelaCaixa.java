...
//        }
    ...
    private void initComponents() {
        ...
        tableVenda.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Produto", "Valor", "Quantidade", "Total", "Tamanho"
            }
        ));
    ...
    private void tblPesquisaProdutoVendaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPesquisaProdutoVendaMouseClicked
        ...
        String tamanho = tblPesquisaProdutoVenda.getValueAt((tblPesquisaProdutoVenda.getSelectedRow()), 2).toString();
        ...
        if(numeroLinhasTabela == 0){
          ...
          modelo2.addRow(new Object[]{"" + produto, "" + valor, "0", "0", "" + tamanho});
          tableVenda.updateUI();
        }else{
    ...
    private void btnQauntidadeCaixaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQauntidadeCaixaActionPerformed
        ...
        String tamanho = tableVenda.getValueAt((ultimaLinha), 4).toString();
        ...
        float valorTotal = quantidadeConverter *  valorConverter; 
          ...
          modelo.addRow(new Object[]{"" + produto , "" + valor, "" + quantidade, "" + valorTotal, "" + tamanho});
    ...
    private void tableVendaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableVendaMouseClicked
        ...
        tableVenda.updateUI();
            ...
            if(qtd.equals("0")){
                JOptionPane.showMessageDialog(null, "Por favor, coloque a quantidade do produto para excluí-lo da venda.", "Importante!", JOptionPane.WARNING_MESSAGE);
            } else {
